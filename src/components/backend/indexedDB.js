class IndexedDBConn {
  constructor() {
    ...
    request.onupgradeneeded = (event) => {
      ...
      const historyObjectStore = db.createObjectStore("history", {
        keyPath: "id",
      });
      ...
      const vectorObjectStore = db.createObjectStore("embedding", {
        keyPath: "uuid",
      });
      ...
      const bufferMemoryObjectStore = db.createObjectStore("buffer", {
        keyPath: "sid",
      });
      bufferMemoryObjectStore.createIndex("provider", "provider", {
        unique: false,
      });
    };
