...
test('basic embedding recall test', {timeout: 10000}, // Timeout value in milliseconds
  async () => {
    const data = [
        ...
        {
            "sentence": "The scientific community is working tirelessly to find a cure for cancer.",
        ...
        {
            "sentence": "Learning a new language opens up new opportunities for travel and communication.",
            "query": "What do new language learning opportunities open up?"
        },
        {
            "sentence": "The ancient ruins of Machu Picchu attract tourists from all over the world.",
    ...
    const res = await Promise.all(data.map(async (d) => {
